...
public class report_emp_leave_balance extends GenericForwardComposer {
		  ...
		  try
			{
				...
				year=chkyear.getValue().toString();
...
// Table Data 
											    ...
											    Paragraph subject_to_table=new Paragraph("Leave Details Of Employee for the Year: "+year,subjectFont);
