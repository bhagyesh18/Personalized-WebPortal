...
public class report_emp_leave_details extends GenericForwardComposer {
...
// Table Data 
											    ...
											    Paragraph subject_to_table=new Paragraph("Leave Balance Of Employee",subjectFont);
											    ...
											    Paragraph subject_to_table1=new Paragraph("Leave Details Of Employee",subjectFont);
											    subject_to_table1.setAlignment(Element.ALIGN_CENTER);
											    addEmptyLine(subject_to_table1, 1);
											    document.add(subject_to_table1);
											    ...
											    PdfPCell c111 = new PdfPCell(new Phrase(" Leave Request No" , FontFactory.getFont(FontFactory.HELVETICA, 8)));
											    c111.setHorizontalAlignment(Element.ALIGN_LEFT);
											    c111.setBackgroundColor(BaseColor.LIGHT_GRAY);
											  
											    table11.addCell(c111);
											    
											    
											    c111 = new PdfPCell(new Phrase(" Leave Reason " , FontFactory.getFont(FontFactory.HELVETICA, 8)));
											    c111.setHorizontalAlignment(Element.ALIGN_LEFT);
											    c111.setBackgroundColor(BaseColor.LIGHT_GRAY);
											  
											    table11.addCell(c111);
											    
											    c111 = new PdfPCell(new Phrase(" Leave status " , FontFactory.getFont(FontFactory.HELVETICA, 8)));
											    c111.setHorizontalAlignment(Element.ALIGN_LEFT);
											    c111.setBackgroundColor(BaseColor.LIGHT_GRAY);
											 
											    table11.addCell(c111);
											    
											    c111 = new PdfPCell(new Phrase(" Start Date " , FontFactory.getFont(FontFactory.HELVETICA, 8)));
											    c111.setHorizontalAlignment(Element.ALIGN_LEFT);
											    c111.setBackgroundColor(BaseColor.LIGHT_GRAY);
											 
											    table11.addCell(c111);
											    c111 = new PdfPCell(new Phrase(" End Date " , FontFactory.getFont(FontFactory.HELVETICA, 8)));
											    c111.setHorizontalAlignment(Element.ALIGN_LEFT);
											    c111.setBackgroundColor(BaseColor.LIGHT_GRAY);
											 
											    table11.addCell(c111);
											    c111 = new PdfPCell(new Phrase(" Total Days " , FontFactory.getFont(FontFactory.HELVETICA, 8)));
											    c111.setHorizontalAlignment(Element.ALIGN_LEFT);
											    c111.setBackgroundColor(BaseColor.LIGHT_GRAY);
											    ...
											    table11.setHeaderRows(1);
												 ...
												 {
											    queryclass obj_leave=new queryclass();
												ResultSet rs_leave=obj_leave.selectquery("SELECT `leave_detail`.`leavetype_id`,`leave_detail`.`leave_reason`,`leave_detail`.`leave_permission`,`leave_detail`.`leave_start_date`,`leave_detail`.`leave_end_date`,`leave_detail`.`total_leave_days` FROM `webportal`.`leave_detail` where emp_id='"+ itext_emp_id+"'  ");
													...
													while(rs_leave.next())
													{
														...
														{
															table11.addCell(new Phrase("Casual Leave" , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														}
														else if(rs_leave.getString("leavetype_id").toString().equals("2"))
														{
															table11.addCell(new Phrase("sick Leave" , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														} 
														else
														{
															table11.addCell(new Phrase("Earn Leave" , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														}
														table11.addCell(new Phrase(rs_leave.getString("leave_reason") , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														table11.addCell(new Phrase(rs_leave.getString("leave_permission") , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														table11.addCell(new Phrase(rs_leave.getString("leave_start_date") , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														table11.addCell(new Phrase(rs_leave.getString("leave_end_date") , FontFactory.getFont(FontFactory.HELVETICA, 8)));
														table11.addCell(new Phrase(rs_leave.getString("total_leave_days") , FontFactory.getFont(FontFactory.HELVETICA, 8)));
